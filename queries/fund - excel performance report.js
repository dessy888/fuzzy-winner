db.fund.aggregate([
    ...
    { $lookup: {
           ...
           as: "perf" } },
    { $unwind: "$perf" },
    { $project: { sedol: 1, name: 1, unitType: 1, loaded: 1, company: 1, sector: 1, plusFund: 1, price_sell: 1, price_buy: 1, 
        price_change: 1, yield: 1, initialCharge: 1, annualCharge: 1, annualSaving: 1, netAnnualCharge: 1, discountedCode: 1, 
        perf12m: 1, perf12t24m: 1, perf24t36m: 1, perf36t48m: 1, perf48t60m: 1, fundSize: 1, incomeFrequency: 1, paymentType: 1, 
        numHoldings: 1, updated: 1, 
        'isin': '$perf.isin', 'ftSymbol': '$perf.isin', 'reportName': '$perf.reportName', '1D': '$perf._1D', '3D': '$perf._3D',
